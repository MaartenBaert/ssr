...
&lt;p&gt;Якщо ви хочете вести запис ігор Steam, &lt;a href=&quot;http://www.maartenbaert.be/simplescreenrecorder/recording-steam-games/&quot;&gt;прочитайте важливу інформацію&lt;/a&gt;.&lt;/p&gt;</translation>
    ...
    <message>
        ...
        <translation>Назви каналів використовуються для ідентифікації програм. Єдине, коли варто змінювати назву за замовченням, це у випадку коли ведеться запис одночасно декількох програм.</translation>
    </message>
    <message>
...
Це означає, що інші користувачі (теоретично) можуть бачити те, запис чого ведеться, змінювати  та вставляти кадри, або просто перешкоджати запису. Це стосується навіть ти користувачів, що підключенні по ssh. 
Вмикайте цю опцію тільки для запису програми, що працює під іншим користувачем.</translation>
    </message>
    <message>
...
Це призведе до припинення витрачання процесорного часу для кадрів, що не записуються, та іноді, отримання більш плавного відео (залежить від програми).</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Запис збережено. Ви можете відредагувати відео зараз або перекодувати його з кращим налаштуванням для меншого розміру файла (
налаштування за замовчуванням оптимізовані для якості й швидкості, а не розміру файла).</translation>
    </message>
    <message>
...
The default is usually fine. The &apos;shared&apos; sources allow multiple programs to record at the same time, but they may be less reliable.</source>
        <translatorcomment>За замовчуванням звичайно оптимальне джерело. Інші джерела можуть дозволити запис декількох програм в той же час, але це як правило менш надійно.</translatorcomment>
...
used by the VP8 encoder). Higher values result in lower quality video, unless you increase the bit rate too.</source>
        <translation>Швидкість кодування. Вище значення, використовує *менше * процесорного часу, також вище значення призводить до меншої якості відео, якщо ви не збільшите також бітрейт.</translation>
    </message>
    <message>
...
It shouldn&apos;t affect the appearance of the video.</source>
        <translation>Якщо встановлено, відеокодер буде пропускати кадри якщо вхідна частота кадрів менше ніж вихідна частота кадрів. Якщо не встановлено, вхідні кадри будуть продубльовані для заповнення порожнеч. Це збільшить розмір файлу та використання процесору, але в деяких випадках зменшує затримку при live-стрімах. Це не повинно вплинути на якість відео.</translation>
    </message>
    <message>
...
- AAC це добрий кодек, але імплементації, які тут використовуються (libvo_aacenc або експериментальний ffmpeg aac кодер) дещо жахливі. Використовуйте їх лише за відсутності альтернативи.
...
<context>
    ...
    <message>
        ...
        <translatorcomment>можна чи неможливо?</translatorcomment>
