...
&lt;p&gt;If you want to record Steam games, &lt;a href=&quot;http://www.maartenbaert.be/simplescreenrecorder/recording-steam-games/&quot;&gt;read this first&lt;/a&gt;.&lt;/p&gt;</source>
        <translation>&lt;p&gt;Προειδοποίηση:Η εγγραφή OpenGL λειτουργεί «εκχύοντας» μια βιβλιοθήκη μέσα στο πρόγραμμα που θα εγγραφεί. Αυτή η βιβλιοθήκη θα παρακάμψει κάποιες λειτουργίες του συστήματος προκειμένου να καταγράψει τα καρέ πριν εμφανιστούν στην οθόνη. Αν προσπαθείτε να εγγράψετε ένα παιχνίδι το οποίο προσπαθεί να εντοπίσει απόπειρες «σπασίματος»(hacking) από την πλευρά του «προγράμματος-πελάτη», (θεωρητικά) είναι δυνατόν το παιχνίδι να θεωρήσει την ενέργεια ως «πειρατεία». Αυτό μπορεί να έχει ως αποτέλεσμα την απομάκρυνσή σας από το παιχνίδι(ban). Οπότε είναι καλό να σιγουρέψετε πρώτα ότι το παιχνίδι που προσπαθείτε να εγγράψετε δεν θα σας απαγορεύσει την πρόσβαση(ban). Έχετε προειδοποιηθεί :).&lt;/p&gt;
...
Το πρόγραμμα που εγγράφεται δεν θα αναγνωρίσει το πάτημα του πλήκτρου.</translation>
    ...
    <message>
        ...
        <translation>Σημείωση: Κάνοντας προεπισκόπηση απαιτεί έξτρα επεξεργαστική ισχύ (ειδικά σε υψηλούς ρυθμούς καρέ).</translation>
    </message>
    <message>
        <source>Log</source>
